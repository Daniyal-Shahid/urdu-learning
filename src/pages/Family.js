...
import { familyVocab } from '../data/familyVocab';

function Family() {
  return (
    <div className="py-10">
      <h2 className="text-3xl font-semibold text-primary mb-6 text-center">Family Members</h2>
      ...
      <div className="mt-10 flex justify-center space-x-4">
        <Link to="/lessons/family/quiz" className="btn btn-primary">
          Start Quiz
        </Link>
