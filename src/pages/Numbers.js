...
import { numbersVocab } from '../data/numbersVocab';

function Numbers() {
  return (
    <div className="py-10">
      <h2 className="text-3xl font-semibold text-primary mb-6 text-center">Numbers 1-20</h2>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {numbersVocab.map((item, index) => (
      ...
      <div className="mt-10 flex justify-center space-x-4">
        <Link to="/lessons/numbers/quiz" className="btn btn-primary">
          Start Quiz
        </Link>
